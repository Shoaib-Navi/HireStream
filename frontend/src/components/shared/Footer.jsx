...
// // Replace the socials array with SVG icons directly — no deprecation warnings
...
//                 HireStream<span className="absolute -bottom-1 left-0 w-full h-[2px] bg-[#6a38c2] rounded-full" />
//               </span>
//             </div>

//             {/* Tagline */}
//             <p className="text-lg leading-relaxed text-gray-500 max-w-xs">
//               India's #1 platform connecting ambitious talent with the companies
//               that deserve them. Your dream job is closer than you think.
//             </p>
...
//               </span>
//               <span className="flex items-center gap-2">
//                 <Mail className="h-3.5 w-3.5 text-[#6a38c2]" />
//                 hello@HireStream.in
//               </span>
//               <span className="flex items-center gap-2">
//                 <Phone className="h-3.5 w-3.5 text-[#6a38c2]" />
//                 +91 98765 43210
//               </span>
//             </div>
...
//               <h4 className="text-lg font-semibold uppercase tracking-widest text-gray-300">
//                 {heading}
//               </h4>
...
//                       className="text-lg text-gray-500 hover:text-white transition-colors text-left"
//                     >
//                       {label}
//                     </button>
//                   </li>
...
//         {/* ── CTA Banner (replace the newsletter block with this) ── */}
//         <div className="py-8 border-b border-gray-800">
//           <div className="relative flex flex-col sm:flex-row items-center justify-between gap-6 px-8 py-7 rounded-2xl bg-gradient-to-r from-[#6a38c2]/20 via-[#6a38c2]/10 to-[#f83002]/10 border border-[#6a38c2]/20 overflow-hidden">
...
//               <Link to="/login">
//                 <button className="px-5 py-2.5 rounded-xl border border-gray-600 text-sm font-semibold text-gray-300 hover:border-gray-400 hover:text-white transition-all">
//                   Sign In
//                 </button>
//               </Link>
//               <Link to="/signup">
//                 <button className="px-5 py-2.5 rounded-xl bg-[#6a38c2] hover:bg-[#5b2db0] text-white text-sm font-semibold transition-all flex items-center gap-2 shadow-lg shadow-[#6a38c2]/30">
//                   Create Profile
  ...
  return (
    <footer className="bg-gray-950 text-gray-400 pt-12 pb-6">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {/* Top grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10 pb-10 border-b border-gray-800">
          ...
          <div className="sm:col-span-2 lg:col-span-2 flex flex-col gap-4">
            ...
            <p className="text-sm leading-relaxed text-gray-500 max-w-xs">
              India's #1 platform connecting ambitious talent with the companies that deserve them.
            </p>
            <div className="flex flex-col gap-2 text-xs text-gray-500">
              <span className="flex items-center gap-2"><MapPin className="h-3.5 w-3.5 text-[#6a38c2] shrink-0" />Bangalore, India</span>
              <span className="flex items-center gap-2"><Mail className="h-3.5 w-3.5 text-[#6a38c2] shrink-0" />hello@HireStream.in</span>
              <span className="flex items-center gap-2"><Phone className="h-3.5 w-3.5 text-[#6a38c2] shrink-0" />+91 98765 43210</span>
            </div>
          ...
          {Object.entries(footerLinks).map(([heading, links]) => (
            <div key={heading} className="flex flex-col gap-3">
              <h4 className="text-xs font-semibold uppercase tracking-widest text-gray-300">{heading}</h4>
        ...
        <div className="py-6 border-b border-gray-800">
          <div className="relative flex flex-col sm:flex-row items-center justify-between gap-4 px-5 sm:px-8 py-6 rounded-2xl bg-gradient-to-r from-[#6a38c2]/20 via-[#6a38c2]/10 to-[#f83002]/10 border border-[#6a38c2]/20 overflow-hidden">
            ...
            <div className="absolute -bottom-6 -right-6 h-24 w-24 rounded-full bg-[#f83002]/15 blur-2xl pointer-events-none" />
            <div className="relative z-10 text-center sm:text-left">
              <p className="text-white font-bold text-base">Ready to get hired?</p>
              <p className="text-gray-400 text-xs sm:text-sm mt-1">Join 1M+ professionals who found their dream job on HireStream.</p>
            </div>
            <div className="relative z-10 flex items-center gap-3 shrink-0">
              ...
              <Link to="/signup">
                <button className="px-4 py-2 rounded-xl bg-[#6a38c2] hover:bg-[#5b2db0] text-white text-sm font-semibold transition-all flex items-center gap-2">
        ...
        <div className="pt-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-600">
          ...
          <div className="flex items-center gap-4 flex-wrap justify-center">
            {["Privacy Policy", "Terms of Service", "Cookie Policy"].map((item) => (
              <button key={item} onClick={() => navigate("#")} className="hover:text-gray-400 transition-colors">{item}</button>
            ))}
          </div>
        </div>
